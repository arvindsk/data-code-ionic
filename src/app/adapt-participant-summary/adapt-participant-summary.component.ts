...
@Component({
  selector: 'app-adapt-participant-summary',
  templateUrl: './adapt-participant-summary.component.html',
  styleUrls: ['./adapt-participant-summary.component.scss'],
  providers:[MessageService],
})
export class AdaptParticipantSummaryComponent implements OnInit {
