...
@Component({
  selector: 'app-adapt-summary',
  templateUrl: './adapt-summary.component.html',
  styleUrls: ['./adapt-summary.component.scss'],
  providers:[MessageService],
})
export class AdaptSummaryComponent implements OnInit {
