...
@Component({
  ...
  templateUrl: './baseline-collectdata.component.html',
  styleUrls: ['./baseline-collectdata.component.scss'],
  providers: [MessageService],
})
export class BaselineCollectDataComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['participantId', 'firstName', 'lastName', 'dob', 'registeredDate', 'baselineStatus'];
  public flyout = false;
  isMobile = false;
  ...
  constructor(private router: Router,
    ...
    breakpointObserver.observe(['(max-width: 600px)']).subscribe(result => {
      ...
      this.displayedColumns = result.matches ?
        ['participantId', 'firstName', 'lastName', 'dob', 'registeredDate', 'baselineStatus'] :
        ['participantId', 'firstName', 'lastName', 'dob', 'registeredDate', 'baselineStatus'];
    });
  }
